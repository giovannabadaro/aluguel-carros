...
public class Reserva {
    ...
    public Reserva( String dataRetirada, String dataDevolucao, String filial_idFilial1,
			String filial_idFilial, String cliente_idCliente, String modeloCodigo, String custo) {
		this.idReserva = idReserva;
		this.dataRetirada = dataRetirada;
		this.dataDevolucao = dataDevolucao;
		Filial_idFilial1 = filial_idFilial1;
