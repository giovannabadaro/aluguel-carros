...
public class AttCarro extends JInternalFrame {
	 ...
	 */
	public AttCarro() throws ParseException {
		setClosable(true);
		...
		btnPesquisarCarro.setBounds(286, 236, 138, 23);
		getContentPane().add(btnPesquisarCarro);
		
		JLabel lblFilial = new JLabel("Filial");
		lblFilial.setBounds(149, 151, 46, 14);
