...
public class InsMotorista extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InsMotorista frame = new InsMotorista();
	 ...
	 */
	public InsMotorista() throws ParseException {
		setClosable(true);
		FormatedTextMask ftm = new FormatedTextMask();
		setTitle("Cadastrar novo motorista");
		...
		JButton btnNewButton = new JButton("Inserir motorista");
